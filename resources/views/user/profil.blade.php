<x-app-layout>
    ...
    <div class=" mt-10" id="tentang-kami">
        ...
        <div class="bg-secondary-500 text-black py-20 px-60 flex flex-col gap-10 justify-center text-justify text-xl tracking-wide">
            <p>
                Sekolah Pelita Kasih menggunakan kurikulum nasional dan menerapkan nilai-nilai Kristiani. Kami percaya bahwa setiap individu adalah unik dan istimewa dengan kemampuan untuk mengembangkan potensi yang dimikilinya dan menjadi yang terbaik.
            </p>
            <p>
