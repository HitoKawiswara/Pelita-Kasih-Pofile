...
<body class="antialiased bg-zinc-100">
    <div class="contact-button pb-1">
        <a href="#">
            <span class="contact-text mr-8 rounded-l-xl rounded-br-xl text-black bg-white bg-opacity-50 backdrop-blur-sm">Contact Us!</span>
