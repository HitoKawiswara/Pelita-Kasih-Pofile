                ...
                <div class="p-6 text-gray-900">
                    <div class="p-6 text-gray-900">
                        <form action="{{ route('search_structure') }}" method="GET">
                            ...
                            <button type="button" onclick="redirectToAdminStruktur()" class="py-2 px-4 bg-secondary-500 text-white font-semibold rounded-md hover:bg-secondary-600 focus:outline-none focus:bg-secondary-600 mt-3">Cancel</button>
                        </form>
                    </div>
                </div>
            </div>
                                ...
                                <div id="editModal{{ $structure->id }}"
                                    ...
                                    <div class="bg-white rounded-md p-6 w-96 md:w-3/5 lg:w-2/3">
                                        ...
                                        <form id="editForm{{ $structure->id }}" enctype="multipart/form-data">
                                            ...
                                            <div class="mb-4">
                                                <label for="work_as" class="flex justify-start font-semibold mb-1">Menjabat
                                                    Sebagai</label>
                                            ...
                                            <div class="mb-4">
                                                <label for="job_desc" class="flex justify-start font-semibold mb-1">Deskripsi
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <select name="category" id="editCategory{{ $structure->id }}" required
                                                    class="w-full py-2 px-3 border border-gray-300 rounded-md focus:outline-none focus:border-secondary-500">
                                                    <option value="tk">Taman Kanak-Kanak</option>
                                                    <option value="sd">Sekolah Dasar</option>
                                                    <option value="smp">Sekolah Menengah Pertama</option>
